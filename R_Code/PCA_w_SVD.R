...
#					Session 5
#				
#		Principal Components with Singular Value Decomposition
#
#************************************************************
...
traindir <- "C:/Users/jdq6nn/OneDrive - University of Virginia/SYS4021/Data/Trains"
sourcedir <-"C:/Users/jdq6nn/OneDrive - University of Virginia/SYS4021/R_Code"
...
xdmgnd_no <- xdmgnd[-c(4999,5897,7150,5898,7151,4540,6138,5548),]
rownames(xdmgnd_no) <- NULL
pred_no.pca <- prcomp(xdmgnd_no[,c("ACCDMG", "TRNSPD", "CARS", "TIMEHR", "TEMP")], scale = T )
